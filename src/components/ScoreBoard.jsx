...
const ScoreBoard = ({ scores, playerName }) => {
    return (
        <div className="flex flex-col gap-3 w-full">
            <div className="flex items-center justify-between bg-slate-950/30 backdrop-blur-md p-4 rounded-2xl border border-white/5 relative overflow-hidden group hover:border-blue-500/30 transition-colors">
            ...
            <div className="flex items-center justify-between bg-slate-950/30 backdrop-blur-md p-4 rounded-2xl border border-white/5 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between bg-slate-950/30 backdrop-blur-md p-4 rounded-2xl border border-white/5 relative overflow-hidden group hover:border-red-500/30 transition-colors">
